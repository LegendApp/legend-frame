...
import { beforeWindowClose, openWindow, setWindowTitle, onWindowEvent } from "@legendapp/spark-desktop-windows";
...
import { registerShortcut } from "@legendapp/spark-desktop-shortcuts";
