...
export const windowsProjectConfig = `// Generated by Legend; extend with configuration plugins.
// Metro platform discovery on non-Windows hosts must not require pwsh.exe.
