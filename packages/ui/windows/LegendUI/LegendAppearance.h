...
inline React::ReactPropertyId<int32_t> ThemePreference() { return {L"Legend.UI", L"ThemePreference"}; }
inline React::ReactNotificationId<int32_t> ThemeChanged() { return {L"Legend.UI", L"ThemeChanged"}; }
...
REACT_MODULE(LegendAppearance, L"Appearance")
struct LegendAppearance : std::enable_shared_from_this<LegendAppearance> {
