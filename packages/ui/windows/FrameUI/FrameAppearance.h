...
inline React::ReactPropertyId<int32_t> ThemePreference() { return {L"Frame.UI", L"ThemePreference"}; }
inline React::ReactNotificationId<int32_t> ThemeChanged() { return {L"Frame.UI", L"ThemeChanged"}; }
...
REACT_MODULE(FrameAppearance, L"Appearance")
struct FrameAppearance : std::enable_shared_from_this<FrameAppearance> {
