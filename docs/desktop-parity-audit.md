...
[macOS context](../packages/desktop-app/macos/LegendDesktop.mm),
[Windows application host](../packages/desktop-host/windows/application.inc)
(`WindowProc`, `LegendDesktopApp::call`).
...
[Windows picker](../packages/file-dialog/windows/LegendFileDialog/LegendFileDialog.h).
...
[macOS style/persistence](../packages/desktop-app/macos/LegendWindow.mm).
...
[Nitro adapter](../patches/windows/nitro/windows/LegendNitro),
