...
bun .cli/node_modules/@legendapp/spark-cli/src/index.ts create /path/to/MyApp --universal
# Or create the complete example:
bun .cli/node_modules/@legendapp/spark-cli/src/index.ts create /path/to/MyEditor --example document-editor
```
