...
`.spark/test-results/47b6dd3a-9a0c-4a59-889c-98a267dce255.json`.
...
- `.spark/file-stream-tests/report.json`
- `.spark/filesystem-recheck-2026-09-18.json`
- `.spark/desktop-foundation-tests/report.json`
- `.spark/lifecycle-recheck-2026-09-18.json`
...
- `.spark/platform-tests/Platformmacos1789723747074` (initial bundle failure)
- `.spark/platform-tests/Platformmacos1789723802516` (native acceptance consumer)
...
Evidence: `.spark/keyboard-tests/report.json`, `.spark/keyboard-crash-before.log`,
`.spark/keyboard-after-app.log`. The temporary UI probe was removed. Windows was not
