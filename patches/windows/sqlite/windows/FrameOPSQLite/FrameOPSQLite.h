...
REACT_MODULE(FrameOPSQLiteModule, L"OPSQLite")
struct FrameOPSQLiteModule {
  ...
  ~FrameOPSQLiteModule() { if (generation) opsqlite::invalidate(generation); }
  static std::filesystem::path Directory() {
    wchar_t project[32768]{}; if (!GetEnvironmentVariableW(L"FRAME_PROJECT_ID", project, 32768)) throw winrt::hresult_invalid_argument(L"Missing project identity");
    ...
    path /= L"Frame"; path /= id.c_str(); path /= L"data"; std::filesystem::create_directories(path); return path;
  }
