...
import { createMediaSession, type MediaSession } from "@legend-apps/audio";
...
export function MediaSessionDemo({ report }: { report: (value: unknown) => void }) {
  ...
  return <View style={{ gap: 8 }}>
    ...
    <ActionButton onPress={async () => {
      const next = await createMediaSession({ metadata: { title: "Kitchen Sink", artist: "Legend" }, playbackState: "paused", duration: 120,
