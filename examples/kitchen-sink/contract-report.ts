...
export const catalog: CaseDefinition[] = [
  ...
  ...[
    ...
    ["drag-drop", "Native drag and drop"], ["context-menu", "Native context menu actions"],
    ["global-shortcuts", "Shortcuts while another app has focus"], ["processes", "Child process lifecycle"],
    ["system", "System APIs"], ["filesystem", "Filesystem operations and watching"],
    ["settings", "Persistent settings"], ["recent-documents", "Recent document history"],
    ["rich-clipboard", "Rich clipboard formats"], ["modal-windows", "Owned and modal windows"],
    ["advanced-menus", "Menu targeting and accelerators"], ["associations", "OS file and URL associations"],
