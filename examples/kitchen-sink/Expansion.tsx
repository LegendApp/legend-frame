...
const webHTML = `<html><body style="font:16px system-ui;padding:16px"><h3>Embedded WebKit</h3><button onclick="window.ReactNativeWebView.postMessage('Hello from WebView')">Send a message to React Native</button></body></html>`;
