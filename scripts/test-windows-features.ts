...
for (const name of ["@legendapp/spark-file-dialog", "@legendapp/spark-desktop-windows", "@legendapp/spark-file-system", "@legendapp/spark-settings"]) pkg.dependencies[name] = pkg.overrides[name];
...
import * as Files from '@legendapp/spark-file-dialog';
import * as FileSystem from '@legendapp/spark-file-system';
import { settings } from '@legendapp/spark-settings';
import { filesystemLifecycle, settingsLifecycle } from './desktop-contract-cases';
import * as Windows from '@legendapp/spark-desktop-windows';
