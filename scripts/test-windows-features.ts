...
for (const name of ["@legendapp/frame"]) pkg.dependencies[name] = pkg.overrides[name];
...
import * as Files from '@legendapp/frame/dialogs';
import * as FileSystem from '@legendapp/frame/files';
